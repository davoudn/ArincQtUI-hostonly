...
static constexpr auto qt_meta_stringdata_ZN17TransmitterWorkerE = QtMocHelpers::stringData(
    "TransmitterWorker",
    "sendData",
    "",
    "char*",
...
Q_CONSTINIT static const uint qt_meta_data_ZN17TransmitterWorkerE[] = {
...
Q_CONSTINIT const QMetaObject TransmitterWorker::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17TransmitterWorkerE.offsetsAndSizes,
    qt_meta_data_ZN17TransmitterWorkerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17TransmitterWorkerE_t,
        // Q_OBJECT / Q_GADGET
...
void TransmitterWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = bool (TransmitterWorker::*)(char * );
            if (_q_method_type _q_method = &TransmitterWorker::sendData; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *TransmitterWorker::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17TransmitterWorkerE.stringdata0))
