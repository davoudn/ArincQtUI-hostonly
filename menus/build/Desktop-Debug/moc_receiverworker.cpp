...
Q_CONSTINIT static const uint qt_meta_data_ZN14ReceiverWorkerE[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
      ...
      11,    0,   67,    2, 0x06,    7 /* Public */,
      12,    0,   68,    2, 0x06,    8 /* Public */,

 // slots: name, argc, parameters, tag, flags, initial metatype offsets
      13,    0,   69,    2, 0x0a,    9 /* Public */,
      14,    0,   70,    2, 0x0a,   10 /* Public */,
      15,    0,   71,    2, 0x0a,   11 /* Public */,
      16,    4,   72,    2, 0x0a,   12 /* Public */,

 // signals: parameters
    QMetaType::Bool, 0x80000000 | 3, 0x80000000 | 3, 0x80000000 | 6, QMetaType::Float, 0x80000000 | 9,    4,    5,    7,    8,   10,
    QMetaType::Void,
    QMetaType::Void,
 ...
 // slots: parameters
    ...
    QMetaType::Void,
    QMetaType::Void,
    QMetaType::Void, 0x80000000 | 17, 0x80000000 | 17, 0x80000000 | 20, 0x80000000 | 22,   18,   19,   21,   23,
...
void ReceiverWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = bool (ReceiverWorker::*)(uint32_t , uint32_t , str_t , const float & , const QVariant & );
            if (_q_method_type _q_method = &ReceiverWorker::setLabelData; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (ReceiverWorker::*)();
            if (_q_method_type _q_method = &ReceiverWorker::idleLabelCleaner; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (ReceiverWorker::*)();
            if (_q_method_type _q_method = &ReceiverWorker::evalDataRates; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
