...
static constexpr auto qt_meta_stringdata_ZN14EditorDelegateE = QtMocHelpers::stringData(
    "EditorDelegate"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN14EditorDelegateE[] = {
...
Q_CONSTINIT const QMetaObject EditorDelegate::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN14EditorDelegateE.offsetsAndSizes,
    qt_meta_data_ZN14EditorDelegateE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN14EditorDelegateE_t,
        // Q_OBJECT / Q_GADGET
...
void *EditorDelegate::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN14EditorDelegateE.stringdata0))
