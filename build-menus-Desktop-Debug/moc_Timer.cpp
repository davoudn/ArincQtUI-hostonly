...
Q_CONSTINIT static const qt_meta_stringdata_Timer_t qt_meta_stringdata_Timer = {
    {
        ...
        QT_MOC_LITERAL(6, 9),  // "onTimeout"
        QT_MOC_LITERAL(16, 0),  // ""
        QT_MOC_LITERAL(17, 11)   // "counterTask"
    },
    "Timer",
    "onTimeout",
    "",
...
void Timer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Timer::*)();
            if (_t _q_method = &Timer::onTimeout; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
