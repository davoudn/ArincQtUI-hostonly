...
#include <memory>
#include "../menus/editordelegate.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_EditorDelegate_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_EditorDelegate_t qt_meta_stringdata_EditorDelegate = {
    {
        QT_MOC_LITERAL(0, 14)   // "EditorDelegate"
    },
    "EditorDelegate"
};
...
Q_CONSTINIT static const uint qt_meta_data_EditorDelegate[] = {
...
Q_CONSTINIT const QMetaObject EditorDelegate::staticMetaObject = { {
    ...
    qt_meta_stringdata_EditorDelegate.offsetsAndSizes,
    qt_meta_data_EditorDelegate,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_EditorDelegate_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<EditorDelegate, std::true_type>
    >,
    nullptr
} };
